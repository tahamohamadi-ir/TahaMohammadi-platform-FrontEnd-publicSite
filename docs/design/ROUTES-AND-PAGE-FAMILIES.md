...
| Atlas               | `/{locale}/atlas/` bilingual Knowledge Atlas (EN/FA, same topology)                                 |
| Atlas draft preview | `/{locale}/atlas/preview/` fragment-scoped owner preview (`noindex`; not in sitemap / locale index) |

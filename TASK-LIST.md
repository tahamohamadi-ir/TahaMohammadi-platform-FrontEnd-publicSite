...
- [~] **PUBLIC-290** Performance budget (LCP, CLS, font preload). Evidence: `docs/quality/PUBLIC-290-PERFORMANCE-BUDGET.md`, `public-290.performance-budget.test.ts`, Playwright `@performance` probes on home + creative index. Production 75th-percentile telemetry remains open.

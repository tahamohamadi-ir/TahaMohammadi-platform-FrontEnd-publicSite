...
Language gateway, bilingual home, profile pages, research, projects, writing, publications, teaching, creative work, CV/resume, contact, search, metadata, accessibility, performance, and responsive presentation.

## Explicitly not owned

Authoring, moderation, publishing, authentication policy, backend models, database migrations, infrastructure secrets, and deployment approval.

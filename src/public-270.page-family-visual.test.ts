...
const checklistPath = path.join(repositoryRoot, 'docs', 'quality', 'PUBLIC-270-PAGE-FAMILY-VISUAL-EVIDENCE.md');
const e2ePath = path.join(repositoryRoot, 'tests', 'e2e', 'public-270-page-families.visual.e2e.ts');

const PAGE_FAMILY_ROUTE_MAP = [
  { pf: 'PF-01', concept: 'creative-index-light.png', routes: ['/{locale}/creative/'] },
  { pf: 'PF-02', concept: 'creative-detail-dark.png', routes: ['/{locale}/creative/{slug}/'] },
  { pf: 'PF-03', concept: 'writing-index-light.png', routes: ['/{locale}/writing/'] },
  { pf: 'PF-04', concept: 'projects-index-dark.png', routes: ['/{locale}/projects/'] },
  { pf: 'PF-05', concept: 'research-publications-index-light.png', routes: ['/{locale}/research/', '/{locale}/publications/'] },
  { pf: 'PF-06', concept: 'teaching-index-dark.png', routes: ['/{locale}/teaching/'] },
  { pf: 'PF-07', concept: 'about-cv-light.png', routes: ['/{locale}/about/', '/{locale}/cv/'] },

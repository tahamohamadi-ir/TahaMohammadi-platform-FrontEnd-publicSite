...
const fixtureCopy = {
  en: {
    loading: { title: 'Loading records', message: 'Fetching the latest published items.' },
    empty: { title: 'No records yet', message: 'Nothing is published in this collection.', actionLabel: 'Browse home', actionHref: '/en/' },
    unavailable: { title: 'Section unavailable', message: 'This route is not published yet.' },
    error: { title: 'Request failed', message: 'Try again or return home.', actionLabel: 'Retry', actionHref: '/en/' },
    untranslated: {
    ...
    'no-results': { title: 'No matching results', message: 'Adjust filters or clear the query.', actionLabel: 'Clear filters', actionHref: '/en/writing/' },
  },
  fa: {
    loading: { title: 'در حال بارگذاری', message: 'در حال دریافت آخرین موارد منتشرشده.' },
    empty: { title: 'موردی ثبت نشده', message: 'در این مجموعه محتوای منتشرشده‌ای وجود ندارد.', actionLabel: 'بازگشت به خانه', actionHref: '/fa/' },
    unavailable: { title: 'بخش در دسترس نیست', message: 'این مسیر هنوز منتشر نشده است.' },
    error: { title: 'درخواست ناموفق بود', message: 'دوباره تلاش کنید یا به خانه برگردید.', actionLabel: 'تلاش مجدد', actionHref: '/fa/' },
    untranslated: {
    ...
    'no-results': { title: 'نتیجه‌ای یافت نشد', message: 'فیلترها را تغییر دهید یا جستجو را پاک کنید.', actionLabel: 'پاک کردن فیلترها', actionHref: '/fa/writing/' },
  },
} as const;
